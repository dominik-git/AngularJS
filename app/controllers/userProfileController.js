(function () {
    ...
    function userProfileController($scope,dataService,$modal) {
       ...
       // $scope.active = false;
        ...
        $scope.currentTab = './html/profilePage/profileTabs/contactInfo.html'; /*default tab*/
        $scope.current = 'Contact Info'; /*default active tab*/
        $scope.currentEditForm = './html/profilePage/profileTabs/editProfile/editContact.html';/*current edit form*/
